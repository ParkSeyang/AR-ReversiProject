...
public class Study_Lamda : MonoBehaviour
{
    ...
    void LambdaTwo()
    {
        ...
        Action<string> methodB = (message) =>
        {
            Debug.Log($"MethodB : {message}");
        };
    ...
    void LambdaFour()
    {
        ...
        Func<int, int,bool> method = (numA, numb) =>
        {
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Alpha1))
        {
            LambdaThree((number) =>
            {
                Debug.Log($"Lambda Three Alpha1: {number}");
            });
        }
        ...
        if (Input.GetKeyDown(KeyCode.Alpha2))
        {
            LambdaThree((number) =>
            {
                Debug.Log($"Lambda Three Alpha2: {number * 20}");
            });
        }
        ...
        if (Input.GetKeyDown(KeyCode.Alpha3))
        {
            LambdaThree((number) =>
            {
                Debug.Log($"Lambda Three Alpha3: {number * 30}");
            });
        }
    }
}
